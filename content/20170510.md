...
漸開線定義：一直線在一圓(稱為基圓)外滾動，線上一點所經過的軌跡

漸開線齒形之特性：

(1)漸開線之形成，全由基圓之大小決定。基圓愈小，漸開線之曲率半徑愈小，曲率愈大。
(2)漸開線上任一點之法線，必與基圓相切。
(3)輪齒在基圓以上為漸開線，基圓以下則為徑向直線。齒條之齒面及齒腹均為直線(基圓半徑無窮大)。
(4)接觸線為直線，壓力角為定值。
(5)一對齒輪知囓合， 保持一定轉速比之條件為：兩齒輪之周節與壓力角相同。
